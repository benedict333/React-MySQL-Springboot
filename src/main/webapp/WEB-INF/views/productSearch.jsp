...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="com.claim.entity.Product"%>
<!DOCTYPE html>
<html>

<%
	Product search1 = (Product) session.getAttribute("search1");
%>
<head>
...
<h3>Search</h3>
        ...
        <form:form method="post" ACTION ="searchProducts" modelAttribute = "search"  id="search_form">
          <p>
            <form:input class="search"  path="search"  name="search_field" placeholder ="Enter keywords....." />
            <input type ="image" style="border: 0; margin: 0 0 -9px 5px;" src="style/search.png" alt="Search" title="Search" />
                 </p>   
